...
// Données d'exemple pour la popularité des menus
...
// Données d'exemple pour les performances des employés
...
// Données d'exemple pour l'affluence
...
const DashboardPage: React.FC<DashboardPageProps> = ({ currentPage, onNavigate }) => {
  ...
  // Données pour le graphique en secteurs (Momo vs Espèces)
